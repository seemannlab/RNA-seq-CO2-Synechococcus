...
ggsave('analysis/H_signal-probs.jpeg',
...
write_tsv(signal2, 'analysis/H_signals.tsv')
...
signal2 |>
  ...
  write_tsv('analysis/H_overview.tsv')
...
pheatmap::pheatmap(
  ...
  filename = 'analysis/H_heatmap.jpeg'
)
dev.off()
...
write_tsv(signal.enrich, 'analysis/H_signal-enrichment.tsv')
...
ggsave('analysis/H_signal-enrichment.jpeg',
...
write_tsv(gene.path, 'analysis/H_gene2pathway.tsv')
...
signal.enrich |>
  ...
  write_tsv('analysis/H_enriched-genes.tsv')
