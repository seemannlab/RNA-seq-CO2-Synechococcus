...
# https://www.kegg.jp/pathway/syp00030
# Glycolysis
# https://www.kegg.jp/pathway/syp00010
...
ggsave('analysis/L_photorespiration.jpeg',
...
ggsave('analysis/L_carotenoid.jpeg',
...
# remove ugly thick border
baz + theme(plot.margin = unit(c(-1, -2, -1, -2), "cm"))
ggsave('analysis/L_vancomycin.jpeg',
...
# remove ugly thick border
baz + theme(plot.margin = unit(c(-1, -2, -1, -2), "cm"))
ggsave('analysis/L_peptidoglycan.jpeg',
...
# remove ugly thick border
baz + theme(plot.margin = unit(c(-1, -2, -1, -2), "cm"))
ggsave('analysis/L_recombination.jpeg',
...
# remove ugly thick border
baz + theme(plot.margin = unit(c(-1, -2, -1, -2), "cm"))
ggsave('analysis/L_pentose.jpeg',
...
# remove ugly thick border
baz + theme(plot.margin = unit(c(-1, -2, -1, -2), "cm"))
ggsave('analysis/L_glycolysis.jpeg',
...
# remove ugly thick border
baz + theme(plot.margin = unit(c(-1, -2, -1, -2), "cm"))
ggsave('analysis/L_nicotinate.jpeg',
       width = 11.5, height = 8, dpi = 400)
...
# remove ugly thick border
baz + theme(plot.margin = unit(c(-1, -2, -1, -2), "cm"))
ggsave('analysis/L_2component.jpeg',
