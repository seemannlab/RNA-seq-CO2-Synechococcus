...
ggsave('analysis/I_correlation-aa-length.jpeg',
...
ggsave('analysis/I_length-log-normal.jpeg', width = 4, height = 4, dpi = 400)
...
ggsave('analysis/I_binomial-model.jpeg', width = 16, height = 9)
...
ggsave('analysis/I_negative-binomial-model.jpeg', width = 16, height = 9)
...
aa.ps |>
  write_tsv('analysis/I_aa-analysis.tsv')
...
ggsave('analysis/I_volcano-like.jpeg', width = 12, height = 8)
...
list(
  'DE coding gene' = deg |>
    filter(is.de, type == 'protein-coding') |>
    pull(Geneid) |>
    unique(),
...
dat.mat <-
  ...
  apply(1, scale) |>
  t() |>
  magrittr::set_colnames(colnames(dat.mat))
